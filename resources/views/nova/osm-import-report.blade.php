...
<body>
    ...
    <div class="wrap">
        ...
        <div class="banner warning">{{ __(':count OSM IDs were skipped because they exceeded the per-run limit (OSM_IMPORT_MAX_IDS_PER_RUN). Import the remaining IDs in another run.', ['count' => (int) $report['truncated_beyond_limit']]) }}</div>
        @endif
